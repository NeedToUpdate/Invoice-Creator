...
export default function Button(props: props) {
  const getIcon = (type: validIcon) => {
    switch (type) {
      case "check":
        return <DocumentCheckIcon className="w-5 h-5 text-primary-600 dark:text-white"></DocumentCheckIcon>;
      case "save":
        return <SaveIcon className="w-5 h-5 text-primary-600 dark:text-white"></SaveIcon>;
      default:
        return <></>;
    }
  };
